...
# 调用 llc as ld 生成可执行文件
llc "$new_file_name" -o "$file_base.s"
as "$file_base.s" -o  "$file_base.o"
ld -dynamic-linker /lib64/ld-linux-x86-64.so.2 -o "$executable_file_name" /usr/lib/x86_64-linux-gnu/crt1.o "$file_base.o" -lc /usr/lib/x86_64-linux-gnu/crti.o /usr/lib/x86_64-linux-gnu/crtn.o
